...
class Product
{
    ...
    public function productInsert($data, $file)
    {
        ...
        $uploaded_image = "upd/".$unique_image;
    ...
    public function latestFromBilco()
    {
    ...
    public function latestFromColas()
    {
    ...
    public function latestFromBhachu()
    {
    ...
    public function getBrandProductBilco()
    {
        $query = "SELECT * FROM tbl_product WHERE brandId = '5' ORDER BY productId DESC LIMIT 2";
        $result = $this->db->select($query);
        return $result;
    }
    public function getBrandProductColas()
    {
        $query = "SELECT * FROM tbl_product WHERE brandId = '1' ORDER BY productId DESC LIMIT 2";
        $result = $this->db->select($query);
        return $result;
    }
    public function getBrandProductChu()
    {
        $query = "SELECT * FROM tbl_product WHERE brandId = '4' ORDER BY productId DESC LIMIT 2";
        $result = $this->db->select($query);
        return $result;
    }
